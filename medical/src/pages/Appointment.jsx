...
const Appointment = () => {
  ...
  const getAvailableSlots = async () => {
    ...
    for(let i=0; i<7; i++){
      ...
      newDocSlots.push({ date: new Date(today.getTime() + i * 86400000), slots: timeSlots });
    }
  ...
  if (loading) {
    return <div className="flex justify-center items-center min-h-[300px]">Loading doctor information...</div>
  }

  if (!docInfo) {
    return <div className="flex justify-center items-center min-h-[300px]">Doctor not found</div>
  }
